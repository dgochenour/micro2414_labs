    ...
    Long count)
{
    ...
    *dp_qos.discovery.initial_peers.get_reference(0) = String_dup(peer);
    ...
    dp_qos.resource_limits.remote_participant_allocation = 10; // LAB #2 -- was 8;
    dp_qos.resource_limits.remote_reader_allocation = 32; // LAB #2 -- was 8;
    dp_qos.resource_limits.remote_writer_allocation = 32; // LAB #2 -- was 8;
    ...
    strcpy(
        this->type_name,
        PoseTypeSupport::get_type_name());
    retcode = PoseTypeSupport::register_type(
        this->participant,
        this->type_name);
    ...
    strcpy(this->topic_name, "Example Pose");
...
Application::~Application()
{
    ...
    if (this->participant != NULL)
    {
        ...
        retcode = TheParticipantFactory->delete_participant(this->participant);
